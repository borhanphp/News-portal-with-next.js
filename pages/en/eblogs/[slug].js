...
import RelatedNews from '../../../components/english-view/eblog/RelatedNews';
...
const SingleBlog = ({ blog, query }) => {
    ...
    const head = () => (
        <Head>
            ...
            <link rel="canonical" href={`${DOMAIN_IP}/en/eblogs/${query.slug}`} />
            <meta property="og:title" content={`${blog?.title}| ${APP_NAME}`} />
            <meta property="og:description" content={blog?.mdesc} />
            <meta property="og:type" content="webiste" />
            <meta property="og:url" content={`${DOMAIN_IP}/en/eblogs/${query.slug}`} />
        ...
        <React.Fragment>
            ...
            <Layout>
                ...
                <main>
								...
								<div className='row align-items'>
									<div className='col-lg-12'>
										...
										<div className={ fontChange === true ? `${styles.body_font}` : ""}>
											...
											<FacebookShareButton className={`${styles.social_icon_btn} ${styles.social_fb}`} children={<FacebookIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<LinkedinShareButton className={`${styles.social_icon_btn} ${styles.social_lnk}`} children={<LinkedinIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<PinterestShareButton className={`${styles.social_icon_btn} ${styles.social_pin}`} children={<PinterestIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<RedditShareButton className={`${styles.social_icon_btn} ${styles.social_red}`} children={<RedditIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<TumblrShareButton className={`${styles.social_icon_btn} ${styles.social_tum}`} children={<TumblrIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<TwitterShareButton className={`${styles.social_icon_btn} ${styles.social_twi}`} children={<TwitterIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											<WhatsappShareButton className={`${styles.social_icon_btn} ${styles.social_what}`} children={<WhatsappIcon className={styles.social_icon} size={32} round={true} />} url={`${DOMAIN_IP}/en/eblogs/${blog.slug}`}/>
											...
											<div className='col-4'>
												...
												<p className='text-muted' 
													style={{
														...
														In "{blog?.ecategories?.filter((item) => {return item.show === 'true'}).slice(0, 1).map((c) => 
															<Link href={`/categories/${c.slug}`}>
					...
					<div className={`row hideindesktop`}>
                    <div className={`col-12`}>
                        ...
                        <div className="container">
							<div className='mt-4 mb-2'>
								<div className='col-md-12'>
								  <p className={styles.america}> Read More  <BsChevronDoubleRight size="17px"/></p>
