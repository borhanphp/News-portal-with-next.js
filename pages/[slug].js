                            ...
                            <section>
								<div className='row align-items'>
									<div className='col-lg-12'>
										...
										<h5 className='fs-2 pb-1 fw-bold text-start'>
										...
										<div className='row'>
											...
											<div className='col-6'>
												 <p className={ fontChange === true ? `${styles.body_font}` : ""}>
												 	By <Link href={`/profile/${blog?.postedBy.username}`}><a>{blog?.postedBy.name}</a></Link>&nbsp;
													<AiOutlineClockCircle/> {date}
													{/* On {blog?.categories.slice(0, 1).map((c) => 
													<Link href={`/category/${c.slug}`}>
													<span style={{cursor: 'pointer'}}>{c.name === "undefined" ? '' : c.name}</span>
													</Link>
												)} */}
										...
										<div className={ fontChange === true ? `${styles.body_font}` : ""}>
											...
											<div className='mt-5 mb-4'>
												<span className=''>
													<span className='mt-5 mb-5' style={{fontWeight: 'bold'}}>Category:&nbsp; 
                        ...
                        <div className="container">
                            <div className='mt-4 mb-2'>
								<div className='col-md-12'>
								  <p className={styles.america}>Related Article<BsChevronDoubleRight size="17px"/></p>
