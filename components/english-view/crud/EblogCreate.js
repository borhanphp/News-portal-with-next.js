...
import { getSubCategories } from '../../../actions/esubcategory';
...
const CreateBlog = ({ router, images }) => {
    ...
    //         subcategories &&
    //         subcategories.filter((dd) => {
    //             console.log('id from filter', dd.category[0]._id);
    //             let filtereditem = dd.category[0]._id === catid;
    //             return console.log('filterdata',filtereditem);
    //         })
    //         .map((s, i) => {
    //             return (
    //                 <>
    ...
    //                 <label className="form-check-label">&nbsp;&nbsp;{s.category.map((sss) => {return sss._id})}</label>
    //             </li>
    //             </>
    //             )
    //         })
                ...
                {/* subcategory setting here */}
                   ...
                   <Collapse in={open}>
                    ...
                    {subcategories?.filter((ddd) => {
                        let filterdaaa = ddd?.ecategory[0]?._id === c._id;
                        return filterdaaa;
                    }).map((s, i) => 
                        <ul>
                            <li key={i} className="list-unstyled">
