...
const Reciepe = () => {
  ...
  useEffect(() => {
      axios.get(`${API}/onlycat?limit=4&cat=62dc143f8e9c47f21a1499ed`)
      .then((res) => {setReciepe(res.data)})
  ...
  return (
        <div className='col-md-3'>
          ...
          <Link href='/category/রেসিপি'><p className={styles.america2} style={{cursor: "pointer"}}>রেসিপি <BsChevronDoubleRight size="17px"/></p></Link>
          ...
          <div className='row'>
            <div className='px-1'>
              <div className='col-md-12 border'>
                  ...
                  <Image src={`${IMG_API}/${reciepe[0]?.photo}`} width = '100' height = '60' layout="responsive"/>
                  <div>
                    <Link href={`/${reciepe[0]?.slug}`}>
