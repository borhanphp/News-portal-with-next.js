...
const Religion = () => {
    ...
    useEffect(() => {
        axios.get(`${API}/onlycat?limit=4&cat=62dc13178e9c47f21a1499e8`)
  ...
  return (
        <div className='col-md-3'>
          ...
          <Link href='/category/ধর্ম'><p className={styles.america2} style={{cursor: "pointer"}}>ধর্ম <BsChevronDoubleRight size="17px"/></p></Link>
          ...
          <div className='row'>
            <div className='px-1'>
                <div className='col-md-12 border'>
                  ...
                  <Image src={`${IMG_API}/${religion[0]?.photo}`} width = '100' height = '60' layout="responsive" />
                  <div>
                    <Link href={`/${religion[0]?.slug}`}>
