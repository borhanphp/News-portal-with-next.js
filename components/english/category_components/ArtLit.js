...
const ArtLit = () => {
    ...
    useEffect(() => {
        axios.get(`${API}/onlycat?cat=62dc150b8e9c47f21a1499f0`)
    ...
    <>
         <div className='col-md-3'>
            ...
            <div className='row mt-4 mb-2'>
                ...
                <Link href='/categories/শিল্পসাহিত্য'><p className={styles.america2}>শিল্প ও সাহিত্য <BsChevronDoubleRight size="17px"/></p></Link>
              ...
              <div className={styles.rajnitisec}>
                <div className='col-md-12 border'>
                  ...
                  <Image src={`${IMG_API}/${artlit[0]?.photo}`} width = '100' height = '60' layout="responsive" style={{width: "100%", height: "180px"}}/>
                  <div>
