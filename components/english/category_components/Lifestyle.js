    ...
    <>
          <div className='col-md-3'>
            ...
            <div className='row mt-4 mb-2'>
                ...
                <Link href='/categories/লাইফস্টাইল'><p className={styles.america2}>লাইফস্টাইল <BsChevronDoubleRight size="17px"/></p></Link>
              ...
              <div className={styles.rajnitisec}>
                <div className='col-md-12 border'>
                  ...
                  <Image src={`${IMG_API}/${lifestyle[0]?.photo}`} width = '100' height = '60' layout="responsive" style={{width: "100%", height: "180px"}}/>
                  <div>
